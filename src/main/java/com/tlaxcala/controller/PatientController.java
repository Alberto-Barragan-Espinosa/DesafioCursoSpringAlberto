...
@RequestMapping("/patients")//define la ruta padre para todos los servicios de la clase - buena practica: la ruta padre siempre sea en plural
...
public class PatientController {
    ...
    @GetMapping("/pageable")//Mapeo de servicio REST
