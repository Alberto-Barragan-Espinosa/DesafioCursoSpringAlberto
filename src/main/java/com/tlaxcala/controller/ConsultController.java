...
@RequestMapping("/consults")//define la ruta padre para todos los servicios de la clase - buena practica: la ruta padre siempre sea en plural
...
public class ConsultController {
    ...
    public ResponseEntity<ConsultDTO> save(@Valid @RequestBody ConsultListExamDTO dto) {
        ...
        //obtener la ruta de la consula agregandole informacion de la consulta/accion del servicio REST
    ...
    @PostMapping("/search/others")//Mapeo de servicio REST
    ...
    @GetMapping("/search/date")//Mapeo de servicio REST
    ...
    @GetMapping("/callProcedureNative")//Mapeo de servicio REST
    ...
    @GetMapping("/callProcedureProjection")//Mapeo de servicio REST
    ...
    @GetMapping(value = "/generateReport", produces = MediaType.APPLICATION_PDF_VALUE)//Mapeo de servicio REST
    ...
    @PostMapping(value = "/saveFile", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)//Mapeo de servicio REST
    ...
    @GetMapping(value = "/readFile/{idFile}", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)//Mapeo de servicio REST
